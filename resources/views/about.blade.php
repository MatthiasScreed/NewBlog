    ...
    <div class="max-w-7xl mx-auto p-6 lg:p-8">
        ...
        <div class="mt-16">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                <a href="https://www.linkedin.com/in/christophermassamba/" target="_blank" class="scale-100 p-6 rounded-lg shadow-2xl shadow-gray-500/20">
                ...
                <a href="https://github.com/MatthiasScreed/" target="_blank" class="scale-100 p-6 rounded-lg shadow-2xl shadow-gray-500/20">
